    ...
    <?php  } else { ?>
        <form action="" method="post">
            <div class="page-table-header">
                <input type='checkbox' />
                <div class="btn-group">
                    <?php if(mcv('shop.refundaddress.delete')) { ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class='label <?php  if($item['isdefault']==1) { ?>label-primary<?php  } else { ?>label-default<?php  } ?> defaults'
                                    <?php if(mcv('shop.refundaddress.edit')) { ?>
                            ...
                            <td style="text-align:left;">
                                <?php if(mcv('shop.refundaddress.view|shop.refundaddress.edit')) { ?>
                                    <a href="<?php  echo webUrl('shop/refundaddress/edit', array('id' => $item['id']))?>" class="btn btn-op btn-operation">
                                        <span data-toggle="tooltip" data-placement="top" data-original-title="<?php if(mcv('shop.refundaddress.edit')) { ?>修改<?php  } else { ?>查看<?php  } ?>">
