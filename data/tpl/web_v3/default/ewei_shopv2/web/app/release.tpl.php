                ...
                <div class="col-sm-12">
                    <div class="summary_box">
                        ...
                        <div class="summary_lg">
                            <p>将微信小程序授权给系统，系统会自动帮你生成店铺小程序，并提交到微信；你不需要做复杂操作，即可获得店铺的微信小程序。</p>
            ...
            <div class="wxapp-detail">
                ...
                <div class="text">
                    ...
                    <p>审核状态：
                        ...
                        <?php  } else if($release['audit_status']==4 || $release['audit_status']==5) { ?><span class="text-success">发布成功</span>
                ...
                <?php  if($release['audit_status']==2 || $release['audit_status']==5) { ?>				
                    <div class="btn btn-primary btn-audit" data-action="audit" data-text="提交审核">提交审核</div>
                <?php  } else if($release['audit_status']==6) { ?>
    ...
    <script type="text/javascript">
        ...
        $(".btn-audit").click(function () {
            ...
            tip.confirm('确定要'+text+'吗？', function () {
                ...
                $.post(biz.url('app/release/audit'), {
                    action: action
                }, function (ret) {
                    if(ret.status!=1){
        ...
        function authFun() {
            var url = biz.url('app/release/auth');
            window.open(url);
