...
<form <?php if(cv('sysset.sms.set')) { ?>method="post"<?php  } ?> class="form-horizontal form-validate">
    ...
    <div class="page-content">
        ...
        <div class="form-group-title">阿里云短信(新版)<small style="padding-left: 10px;"><a class="text-primary" target="_blank" href="https://home.console.aliyun.com/">立即申请</a></small>
            <span class="pull-right">
                <input type="hidden" value="<?php  echo $item['aliyun_new'];?>" name="aliyun_new" />
                <input class="js-switch small" type="checkbox" <?php  if(!empty($item['aliyun_new'])) { ?>checked<?php  } ?>/>
            </span>
        </div>
        <div class=" sms-aliyun_new" style="<?php  if(empty($item['aliyun_new'])) { ?>display: none;<?php  } ?>">
            <div class="form-group">
                <label class="col-lg control-label must">Access Key ID</label>
                <div class="col-sm-9 col-xs-12">
                    <input type="text" name="aliyun_new_keyid" class="form-control valid" value="<?php  echo $item['aliyun_new_keyid'];?>" data-rule-required="true">
                </div>
            </div>
            <div class="form-group">
                <label class="col-lg control-label must">Access Key Secret</label>
                <div class="col-sm-9 col-xs-12">
                    <input type="text" name="aliyun_new_keysecret" class="form-control valid" value="<?php  echo $item['aliyun_new_keysecret'];?>" data-rule-required="true">
                </div>
            </div>
        </div>
 ...
 -->
       <!--  <div class="form-group-title">阿里云短信<small style="padding-left: 10px;"><a class="text-primary" target="_blank" href="https://market.aliyun.com/products/57002003/cmapi011900.html">立即申请</a></small>
            <span class="pull-right">
        ...
        <div class=" sms-aliyun" style="<?php  if(empty($item['aliyun'])) { ?>display: none;<?php  } ?>">
            <div class="form-group">
                <label class="col-lg control-label must">App Code</label>
                <div class="col-sm-9 col-xs-12">
